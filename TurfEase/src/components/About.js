      ...
      <div className="container py-5">
        ...
        <div className="row">
          <div className="col">
            ...
            <hr className="mb-4" />
            <p>
              Whether you're a sports lover looking for the perfect place to play, or a turf owner wanting to grow your business — TurfZone is the right place for you.
            </p>
            <p>
